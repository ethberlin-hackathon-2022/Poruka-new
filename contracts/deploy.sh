...
forge create --rpc-url $FOUNDRY_ETH_URL --private-key $FOUNDRY_ETH_PRIVATE_KEY src/CreditLine.sol:CreditLine --constructor-args $MOCK_DAI_ADDRESS $NFT_VOUCHER $TRESUARY
